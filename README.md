...
- [**simulate-sdk: Voice AI simulation SDK for generating synthetic conversation datasets to test AI agents across edge-case scenarios**](https://github.com/future-agi/simulate-sdk) *Future AGI.* GitHub.

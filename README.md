...
- [**Future AGI: Open-source platform with simulate-sdk for generating synthetic conversation datasets to test AI agents across edge-case scenarios**](https://github.com/future-agi/future-agi) *Future AGI.* GitHub.
